    ...
    try:
        ...
        if(enterTrade == True):
            ...
            try:
                ...
                if(trade['OrderType'] == 'Buy'):
                    for takeProfit in trade['TP']:
                        result = await connection.create_market_buy_order(trade['Symbol'], trade['PositionSize'] / len(trade['TP']), stopLossPips , takeProfit)
